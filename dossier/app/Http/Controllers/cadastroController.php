    ...
    public function cadastroProfessor(Request $request){
        ...
        if($dados){
            ...
            if(!isset($dados['msg'])){
                ...
                $usuarioModel->telefone = $dados['telefone'];
                $usuarioModel->nascimento = $dados['nascimento'];
                $usuarioModel->ativo = ($dados['status'] == 'ativo' ? true : false);
                $usuarioModel->genero = $dados['genero'];
                $usuarioModel->save();
                
                //do professor
                $professorModel->endereco = $dados['endereco'];
                $professorModel->save();
                ...
                $usuarioTipoModel->ativo = ($dados['status'] == 'ativo' ? true : false);
                $usuarioTipoModel->save();
        ...
        return redirect('secretario/professores');
    }
} 