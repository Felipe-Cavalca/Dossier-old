...
<section class="menu">
    <ul class="nav alunav">
        <li class="nav-item">
            <a class="nav-link navite" href="{{route('professorArmazenamento')}}"> <i class="fas fa-chart-pie"></i> Meu armazenamento</a>
        </li>
        <li class="nav-item">
            <a class="nav-link navite" href="{{route('professorArquivos')}}"> <i class="fas fa-file-alt"></i>Arquivos</a>
        </li>
        <li class="nav-item">
            <a class="nav-link navite" href="{{route('professorGrupos')}}"> <i class="fas fa-users"></i> Grupos</a>
        </li>
        <li class="nav-item">
